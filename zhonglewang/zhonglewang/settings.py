"""
Django settings for zhonglewang project.
...
SECRET_KEY = 'umrk%c8-facstcr!)9db+apyqk=4hmp=lj=fsxv!06%n^=j-0u'
...
WSGI_APPLICATION = 'zhonglewang.wsgi.application'
